...
export class OemComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.cdm.network.oem.Oem',
      'oemId': this.oemId.value,
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceOem.updateParticipant(form.get('oemId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.oemId) {
        formObject.oemId = result.oemId;
      } else {
        formObject.oemId = null;
      }
